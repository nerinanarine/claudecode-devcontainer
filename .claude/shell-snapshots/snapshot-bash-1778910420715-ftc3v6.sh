...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  [[ -x $_cc_bin ]] || _cc_bin=/home/vscode/.local/bin/claude
...
export PATH=/vscode/vscode-server/bin/linux-x64/8b640eef5a6c6089c029249d48efa5c99adf7d51/bin/remote-cli:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
